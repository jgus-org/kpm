...
The [jgus-org/kpm reference implementation](https://github.com/jgus-org/kpm) uses `lib/mk-kpackage.nix`, `lib/mk-repository.nix`, and `lib/check-repository.nix`; those interfaces are repository conventions, not KPM protocol requirements.
