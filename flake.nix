    ...
    let
      ...
      packageSet = system:
        let
          ...
          artifacts = import ./packages { inherit (pkgs) lib; inherit pkgs; };
          repository = import ./lib/mk-repository.nix { inherit (pkgs) lib; inherit pkgs; } {
            inherit artifacts;
          };
        in
        {
    ...
    in
    {
        ...
        let
          ...
          artifactName = artifact:
            ...
            if builtins.length (builtins.filter sameId packageData.artifacts) > 1 then
              ...
              artifact.kpm.id;
          namedArtifacts = builtins.listToAttrs (map
            (artifact: {
      ...
      checks = eachSystem (system:
        ...
        in
        {
          ...
          repository = import ./lib/check-repository.nix
            {
